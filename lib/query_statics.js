...
exports.find = function* (query, options) {
  ...
  var docs = yield function (done) {
    self.collection.find(query, options || {}).toArray(done)
  }
...
exports.findOne = function* (query, options) {
  ...
  var doc = yield function (done) {
    self.collection.findOne(query, options || {}, done)
  }
...
exports.count = function* (query) {
  ...
  return yield function (done) {
    self.collection.count(query || {}, done)
  }
}
...
exports.index = function () {
  ...
  return function (done) {
    args.push(done)
    self.collection.index.apply(self.collection, args)
  }
}
